...
import static com.example.rlp.RLPConstants.OFFSET_LONG_ITEM;
import static com.example.rlp.RLPConstants.OFFSET_LONG_LIST;
import static com.example.rlp.RLPConstants.OFFSET_SHORT_ITEM;
import static com.example.rlp.RLPConstants.OFFSET_SHORT_LIST;
...
public final class RLPCodec {
    ...
    static RLPElement encodeCollection(Collection col, Comparator contentOrdering, RLPContext context) {
        ...
        return new RLPList(s.map(x -> readRLPTree(x, context))
